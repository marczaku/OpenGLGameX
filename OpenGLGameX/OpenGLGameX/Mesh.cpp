...
const Vertex Mesh::cubeVertices[36] {
    ...
    Vertex{Vector3{-0.5f, -0.5f, -0.5f},  Color::blue,    Vector2{ 0.0f, 0.0f }},   // back bottom left
    // RIGHT SIDE
    Vertex{Vector3{0.5f,  0.5f, 0.5f},  Color::yellow,  Vector2{ 0.0f, 1.0f }},    // front top right
    Vertex{Vector3{0.5f, -0.5f, 0.5f},  Color::blue,    Vector2{ 0.0f, 0.0f }},   // front bottom right
    Vertex{Vector3{0.5f,  0.5f, -0.5f},  Color::yellow,  Vector2{ 1.0f, 1.0f }},    // back top right
    Vertex{Vector3{0.5f, -0.5f, 0.5f},  Color::blue,    Vector2{ 0.0f, 0.0f }},   // front bottom right
    Vertex{Vector3{0.5f,  0.5f, -0.5f},  Color::yellow,  Vector2{ 1.0f, 1.0f }},    // back top right
    Vertex{Vector3{0.5f, -0.5f, -0.5f},  Color::blue,    Vector2{ 1.0f, 0.0f }},   // back bottom right
};
